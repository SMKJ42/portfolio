...
export function Projects() {
  return (
    ...
    >
      ...
      <p className="w-1/2 mb-6 mt-2 text-sm text-center italic">
        Two of these projects are quite large in size, and are still under
        development. In case you want to see my work, I&apos;ve included them
        here.
      </p>
      <div className="grid md:grid-cols-2 gap-x-8 gap-y-4">
        <h2 className="md:col-span-2 text-center text-2xl font-bold mb-4">
          Full Stack
        </h2>
        <ProjectCard
